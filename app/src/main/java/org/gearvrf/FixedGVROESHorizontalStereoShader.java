...
public class FixedGVROESHorizontalStereoShader extends GVRShader
{
    public static final GVRShaderId ID = new GVRShaderId(FixedGVROESHorizontalStereoShader.class);

    public FixedGVROESHorizontalStereoShader(GVRContext gvrContext)
    {
        ...
        setSegment("FragmentTemplate", TextFile.readTextFile(context, com.bell_labs.drs.miro360.R.raw.fixed_oes_horizontal_stereo_frag));
    }
